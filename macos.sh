...
sudo scutil --set ComputerName "Yolo"
sudo scutil --set HostName "Yolo"
sudo scutil --set LocalHostName "Yolo"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Yolo"
...
# Enable AutoFill (except passwords)
